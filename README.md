---
home: true
heroImage: /favicon-home.svg
heroText: Go 入门指南
tagline: 《The Way to Go》中文译本，中文正式名《Go 入门指南》
actionText: 开始阅读 →
actionLink: /directory.html
features:
- title: 更少的代码
  details: Go 和 Scala 之间具有更多的可比性（都使用更少的代码），而 C++ 和 Java 都使用非常冗长的代码。
- title: 更短的编译
